...
#define GEGL_OP_NAME      segment_kmeans_port
#define GEGL_OP_C_SOURCE  segment-kmeans-port.c
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
      "name",        "port:segment-kmeans",
      "title",       _("K-means Segmentation Port"),
      "description", _("Segment colors using K-means clustering - this plugin is still in GEGL workshop but it is useful for GEGL plugin development"),
      NULL);
}
